        ...
        <section className='pb-[150px]'>
            <div className='container elementCenter mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-[120px]  place-items-center'>
                    <div>
                    <img src="assets/illustration-stay-productive.png" alt="Stay Productive" />
                </div>
                ...
                <div className='tracking-[0.8px] leading-[30px] text-center md:text-start'>
                    ...
                    <a className='flex items-center w-fit  gap-[15px] text-primary hover:text-[#42b0d1] transition-colors duration-200 border-b-2 border-primary mt-5 pb-2 ' href="/"> see how Fylo works <img className=' animate-moveRight w-[20px] object-contain' src="assets/icon-arrow.svg" alt="arrow" /></a>
